...
>
      ...
      <h2 className="text-6xl font-extrabold mt-2 text-white">
        Simple Growth.
      </h2>
      ...
      <div className="flex gap-5 mt-10">
        <a
          ...
          target="_blank"
          className="bg-yellow-400 text-slate-900 px-8 py-4 rounded-xl font-bold hover:bg-yellow-300"
        >
          Apply Now
        </a>
        ...
        <a
          ...
          className="border border-yellow-400 text-yellow-400 px-8 py-4 rounded-xl font-bold hover:bg-yellow-400 hover:text-slate-900"
        >
          Call Now
        </a>
      </div>
